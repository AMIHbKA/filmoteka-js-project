 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function D(){const t="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof t&&void 0!==t.id}function P(){const t=O();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function M(){try{return"object"==typeof indexedDB}catch(t){return!1}}class F extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name="FirebaseError",Object.setPrototypeOf(this,F.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,B.prototype.create)}}class B{create(t,...e){const n=e[0]||{},i=`${this.service}/${t}`,r=this.errors[t],s=r?function(t,e){return t.replace(U,((t,n)=>{const i=e[n];return null!=i?String(i):`<${n}?>`}))}(r,n):"Error",o=`${this.serviceName}: ${s} (${i}).`;return new F(i,o,n)}constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}}const U=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $t;$t="",At(new Q("platform-logger",(t=>new Et(t)),"PRIVATE")),At(new Q("heartbeat",(t=>new jt(t)),"PRIVATE")),Mt("@firebase/app","0.9.7",$t),Mt("@firebase/app","0.9.7","esm2017"),Mt("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class De{async _isAvailable(){return!0}async _set(t,e){this.storage[t]=e}async _get(t){const e=this.storage[t];return void 0===e?null:e}async _remove(t){delete this.storage[t]}_addListener(t,e){}_removeListener(t,e){}constructor(){this.type="NONE",this.storage={}}}De.type="NONE";const Pe=De;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Be(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ve(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ue(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(We(e))return"Blackberry";if($e(e))return"Webos";if(ze(e))return"Safari";if((e.includes("chrome/")||je(e))&&!e.includes("edge/"))return"Chrome";if(qe(e))return"Android";{const e=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=t.match(e);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Ue(t=O()){return/firefox\//i.test(t)}function ze(t=O()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function je(t=O()){return/crios\//i.test(t)}function Ve(t=O()){return/iemobile/i.test(t)}function qe(t=O()){return/android/i.test(t)}function We(t=O()){return/blackberry/i.test(t)}function $e(t=O()){return/webos/i.test(t)}function He(t=O()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function Ke(){return P()&&10===document.documentMode}function Ge(t=O()){return He(t)||qe(t)||$e(t)||We(t)||/windows phone/i.test(t)||Ve(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Pc{ot(t){return this.previousValue=Math.max(t,this.previousValue),this.previousValue}next(){const t=++this.previousValue;return this.ut&&this.ut(t),t}constructor(t,e){this.previousValue=t,e&&(e.sequenceNumberHandler=t=>this.ot(t),this.ut=t=>e.writeSequenceNumber(t))}}function Mc(t){return null==t}function Fc(t){return 0===t&&1/t==-1/0}function Bc(t){return"number"==typeof t&&Number.isInteger(t)&&!Fc(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wd{start(){return Promise.resolve()}shutdown(){return this.Ss=!1,Promise.resolve()}get started(){return this.Ss}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new fd,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let n=this.Ps[t.toKey()];return n||(n=new gd(e,this.referenceDelegate),this.Ps[t.toKey()]=n),n}getTargetCache(){return this.Ds}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.xs}runTransaction(t,e,n){Qa("MemoryPersistence","Starting transaction:",t);const i=new xd(this.Vs.next());return this.referenceDelegate.Ns(),n(i).next((t=>this.referenceDelegate.ks(i).next((()=>t)))).toPromise().then((t=>(i.raiseOnCommittedEvent(),t)))}Os(t,e){return Oc.or(Object.values(this.Ps).map((n=>()=>n.containsKey(t,e))))}constructor(t,e){this.Ps={},this.overlays={},this.Vs=new Pc(0),this.Ss=!1,this.Ss=!0,this.referenceDelegate=t(this),this.Ds=new bd(this),this.indexManager=new sd,this.remoteDocumentCache=function(t){return new yd(t)}((t=>this.referenceDelegate.Cs(t))),this.serializer=new nd(e),this.xs=new dd(this.serializer)}}class xd extends Rc{constructor(t){super(),this.currentSequenceNumber=t}}class kd{static Fs(t){return new kd(t)}get Bs(){if(this.Ms)return this.Ms;throw tc()}addReference(t,e,n){return this.$s.addReference(n,e),this.Bs.delete(n.toString()),Oc.resolve()}removeReference(t,e,n){return this.$s.removeReference(n,e),this.Bs.add(n.toString()),Oc.resolve()}markPotentiallyOrphaned(t,e){return this.Bs.add(e.toString()),Oc.resolve()}removeTarget(t,e){this.$s.hs(e.targetId).forEach((t=>this.Bs.add(t.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next((t=>{t.forEach((t=>this.Bs.add(t.toString())))})).next((()=>n.removeTargetData(t,e)))}Ns(){this.Ms=new Set}ks(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Oc.forEach(this.Bs,(n=>{const i=Ec.fromPath(n);return this.Ls(t,i).next((t=>{t||e.removeEntry(i,bc.min())}))})).next((()=>(this.Ms=null,e.apply(t))))}updateLimboDocument(t,e){return this.Ls(t,e).next((t=>{t?this.Bs.delete(e.toString()):this.Bs.add(e.toString())}))}Cs(t){return 0}Ls(t,e){return Oc.or([()=>Oc.resolve(this.$s.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Os(t,e)])}constructor(t){this.persistence=t,this.$s=new pd,this.Ms=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Op{get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Pp(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Op(this.firestore,t,this._key)}constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}}class Dp{withConverter(t){return new Dp(this.firestore,t,this._query)}constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}}class Pp extends Dp{get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Op(this.firestore,null,new Ec(t))}withConverter(t){return new Pp(this.firestore,t,this._path)}constructor(t,e,n){super(t,e,nu(n)),this._path=n,this.type="collection"}}function Mp(t,e,...n){if(t=X(t),1===arguments.length&&(e=mc.A()),Tp("doc","path",e),t instanceof Rp){const i=xc.fromString(e,...n);return Ip(i),new Op(t,null,new Ec(i))}{if(!(t instanceof Op||t instanceof Pp))throw new rc(ic.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=t._path.child(xc.fromString(e,...n));return Ip(i),new Op(t.firestore,t instanceof Pp?t.converter:null,new Ec(i))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qp{isEqual(t){return this._internalPath.isEqual(t._internalPath)}constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new rc(ic.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new _c(t)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
